          ...
          <div class="col-xl-8 order-xl-1">
            <div class="card bg-secondary shadow">
              ...
              <div class="card-body456">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <label type="email" class="form-control-grey form-control-alternative" disabled defaultValue={account.email}></label>
                        </div>
                      </div>
                      <div class="col-lg-6">
                  ...
                  <div class="password-reset"> <button class="btn btn-sm btn-primary" onClick={requestPWReset}>Send password reset link</button> </div>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <div className="form-control-country" >
                          <select className = "account-country" id="country-selector" defaultValue={languages[0]}>
                            {languages.map(value => (
...
export default Account //AuthCheck(Account)